 ...
 * their field and relationship metadata, including all dbdocs metadata annotations.
 */
public class EntityScanner {
    ...
    /**
     * Reads all dbdocs metadata from EntityMetadata annotation on an entity class
    ...
    /**
     * Reads all dbdocs metadata from FieldMetadata annotation on a field
     * and returns them as a flat key/value map.
     */
